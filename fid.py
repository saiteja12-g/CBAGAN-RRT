...
if __name__ == "__main__":
    ...
    parser = OptionParser()
    parser.add_option("--p1", "--path1", dest="path1", default='results/sagan/ground_truth',
                      help="Path to directory containing the real images")
    parser.add_option("--p2", "--path2", dest="path2", default='results/sagan/sagan_cbam_attention',
    ...
    result = calculate_fid(images1, images2, options.use_multiprocessing, options.batch_size)
    print("Mean FID value =", result)
