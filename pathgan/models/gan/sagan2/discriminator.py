...
from ..layers import Conv, CBAMBlock
...
class MapDiscriminator(nn.Module):
    ...
    def __init__(
        ...
        self.map_attn = CBAMBlock(hid_channels//2)
        self.roi_attn = CBAMBlock(hid_channels//2)
        ...
        self.attn = CBAMBlock(4* hid_channels)
...
class PointDiscriminator(nn.Module):
    ...
    def __init__(
        ...
        self.point_attn = CBAMBlock(3 * hid_channels // 4)
        self.roi_attn = CBAMBlock(hid_channels//4)
