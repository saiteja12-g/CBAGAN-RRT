...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint_path', default='checkpoints/sagan', help='Load directory to continue training (default: "None")')
    parser.add_argument('--batch_size', type=int, default=1, help='"Batch size" with which GAN will be trained (default: 1)')
    parser.add_argument('--save_dir', default='results/sagan/sagan_cbam_attention', help='Save directory (default: "results/sagan")')
